...
function AdminLoginPage() {
  ...
  const handleSubmitlogin = (event) => {
    ...
    axios
      .post("http://localhost:5000/api/adminlogin", logindata)
      .then((res) => {
        if (res.data.Login) {
          alert("Namaste..");
          navigate("/Admindash");
          ...
          <div className="col-2">
            <div className="form-container">
              ...
              <form id="Regform" onSubmit={handleSubmitlogin}>
                ...
                <input
                value={logindata.admin_passwordl}
                onChange={handleinput}
                  type="password"
                  placeholder="Password"
                  name="admin_passwordl"
                  required
                />
          ...
          <div className="right box">
            ...
            <div className="content">
              ...
              <div className="phone">
                ...
                <span className="text">+91 8779****278</span>
              </div>
              <div className="email">
